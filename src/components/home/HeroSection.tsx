...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      // Performans için throttle ekliyoruz
  ...
  return (
    ...
    >
      {/* Background Pattern */}
      <div
        className="absolute inset-0 opacity-30 bg-gradient-pattern"
        aria-hidden="true"
      />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center space-x-2 backdrop-blur-sm px-4 py-2 rounded-full border border-color-primary shadow-sm bg-white/90">
              <Sparkles className="text-color-primary" size={16} aria-hidden="true" />
              <span className="text-sm font-medium text-color-primary">
                Profesyonel Web Tasarım & SEO
              </span>
            </div>
            ...
            <div className="space-y-4">
              <h1
                id="hero-heading"
                className="text-5xl lg:text-7xl font-bold leading-tight text-color-text"
              >
                <span
                ...
                <span className="block text-4xl lg:text-5xl text-color-muted mt-2">
                  ve Dijital Dönüşüm Çözümleri
                </span>
              </h1>
            </div>

            {/* Description */}
            <p className="text-xl leading-relaxed text-color-muted max-w-xl">
              İstanbul{"'"}da{" "}
              <span className="font-semibold text-color-emphasis">SEO uyumlu</span> ve{" "}
              <span className="font-semibold text-color-emphasis">mobil dostu</span> web
              tasarım hizmetleri sunuyoruz. Kurumsal web sitesi, e-ticaret ve UI/UX
              tasarım çözümleriyle markanızı dijital dünyada öne çıkarıyoruz.
            </p>
            ...
            <div className="flex space-x-8 pt-4">
              <div className="text-center">
                <div
                  ...
                  aria-label="100'den fazla tamamlanmış web tasarım projesi"
                >
                  100+
                </div>
                <div className="text-sm text-color-muted">Başarılı Proje</div>
              </div>
              <div className="text-center">
                <div
                  className="text-3xl font-bold text-color-secondary"
                  aria-label="4.9 yıldız ortalama müşteri memnuniyeti puanı"
                >
                  4.9★
                </div>
                <div className="text-sm text-color-muted">Müşteri Memnuniyeti</div>
              </div>
              <div className="text-center">
                <div
                  className="text-3xl font-bold text-color-accent"
                  aria-label="7/24 teknik destek ve bakım hizmeti"
                >
                  24/7
                </div>
                <div className="text-sm text-color-muted">Teknik Destek</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link href="#contact">
                <Button
                  ...
                  icon={<ArrowRight />}
                  iconPosition="right"
                  aria-label="Ücretsiz keşif görüşmesi için iletişime geçin"
                >
                  Ücretsiz Keşif Görüşmesi
                </Button>
              </Link>
              <Link href="#portfolio">
                <Button variant="outline" aria-label="Portföyümüzü inceleyin">
                  Portföyümüzü İncele
                </Button>
              </Link>
            </div>
            ...
            <div className="absolute -top-4 -right-4 rounded-xl p-3 border bg-color-bg border-color-border shadow-lg">
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 rounded-full flex items-center justify-center bg-green-100">
                  <Zap size={12} className="text-green-600" aria-hidden="true" />
                </div>
                <div>
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 rounded-full flex items-center justify-center bg-blue-100">
                  <Code size={12} className="text-color-primary" aria-hidden="true" />
                </div>
                <div>
